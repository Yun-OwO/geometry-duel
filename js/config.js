...
const CONFIG = {
    ...
    AI_PLAN_UPDATE_INTERVAL: 0.15,
    AI_LEVEL: 0.55,
    KNOCKBACK_POWER: 10,
    KNOCKBACK_VARIANCE: 3,
    KNOCKBACK_DECAY: 0.88,
    AI_ULTIMATE_MIN_JABS: 10,
    AI_ULTIMATE_COOLDOWN_STUN: 6.0,
    AI_ULTIMATE_COOLDOWN_CLOSE: 9.0,
    AI_ULTIMATE_COOLDOWN_FAR: 12.0,
